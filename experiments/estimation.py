...
tau_single = m_s_d.predict(df_double[['venue_impact_factor','expit_citation','embedded_experience']]) - m_s_c.predict(df_double[['venue_impact_factor','expit_citation','embedded_experience']])
ate_single = np.mean(tau_single)
mediante_single = np.median(tau_single)
truth_single = 1.0
...
tau_double = m_d_d.predict(df_single[['venue_impact_factor','expit_citation','embedded_experience']]) - m_d_c.predict(df_single[['venue_impact_factor','expit_citation','embedded_experience']])
ate_double = np.mean(tau_double)
mediante_double = np.median(tau_double)
truth_double= 0.0

df_tau['complex_single'] = tau_single
df_tau['complex_double'] = tau_double
fig = plt.figure(figsize=(10.5,9.5))
sns.distplot(tau_single,hist=False,kde_kws={'shade': True})
sns.distplot(tau_double,hist=False,kde_kws={'shade': True})
plt.axvline(ate_single,color='r',linestyle='--',alpha=0.6)
...
tau_single = m_s_d.predict(df_double[['venue_impact_factor','embedded_citation']]) - m_s_c.predict(df_double[['venue_impact_factor','embedded_citation']])
ate_single = np.mean(tau_single)
mediante_single = np.median(tau_single)
truth_single = 1.0
...
tau_double = m_d_d.predict(df_single[['venue_impact_factor','embedded_citation']]) - m_d_c.predict(df_single[['venue_impact_factor','embedded_citation']])
ate_double = np.mean(tau_double)
mediante_double = np.median(tau_double)
truth_double= 0.0

df_tau['learn_comsum_rf_single'] = tau_single
df_tau['learn_comsum_rf_double'] = tau_double
fig = plt.figure(figsize=(10.5,9.5))
sns.distplot(tau_single,hist=False,kde_kws={'shade': True})
sns.distplot(tau_double,hist=False,kde_kws={'shade': True})
plt.axvline(ate_single,color='r',linestyle='--',alpha=0.6)
